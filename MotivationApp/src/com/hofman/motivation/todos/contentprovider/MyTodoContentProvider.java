package com.hofman.motivation.todos.contentprovider;
...
import com.hofman.motivation.todos.database.TodoDatabaseHelper;
...
public class MyTodoContentProvider extends ContentProvider {
	...
	private static final String AUTHORITY = "com.hofman.motivation.todos.contentprovider";
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case TODO_ID:
			...
			if(TextUtils.isEmpty(selection)) {
				...
				rowsDeleted = sqlDB.delete(TodoTable.TABLE_TODO, TodoTable.COLUMN_ID + "=" + id 
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
		...
		//Check if caller requested column which does not exist
		...
		//Make sure all potential listeners are getting notified
